        ...
        <section className={classes.section}>
                <form noValidate autoComplete="off" >
                    <Grid container spacing={0} alignItems="flex-start" justifyContent="center" >
                        ...
                        <TextField id="outlined-basic" label="Content" variant="outlined" multiline rows={12} className={classes.wrtInput} InputLabelProps={{ className: classes.inputTxt}} InputProps={{className:classes.inputTxt }}/>
                    </Grid>
