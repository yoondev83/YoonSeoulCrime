...
const SeoulCrimeMap2016 = props => {
    ...
    return(
        <Container maxWidth="lg" className={classes.container}>
            ...
            <Typography variant="subtitle1" className={classes.message}>*The data is based on the total number of incidents 2016</Typography>
            <ShowSeoulDistrictCrimeData data={props.data} year="2016"/>
        </Container>
    );
};
