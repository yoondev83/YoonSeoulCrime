...
const SeoulCrimeMap2015 = props => {
    ...
    const OnEachDistrict = (district, layer) =>{
        ...
        const totalIncidentsText      = district.properties.totalIncidents_2015;
        ...
        layer.options.fillColor = district.properties.totalIncidents_2015Color;
    ...
    return(
        <Container fixed className={classes.container}>
            ...
            <ShowSeoulDistrictCrimeData data={seoulCrimeData} year="2015"/>
            </>}
        </Container>
    );
};

export default SeoulCrimeMap2015;