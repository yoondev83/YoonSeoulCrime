...
const SeoulCrimeMap2014 = props => {
    ...
    return(
        <Container fixed className={classes.container}>
            ...
            <Typography variant="subtitle1" className={classes.message}>*The data is based on the total number of incidents in 2014</Typography>
            <ShowSeoulDistrictCrimeData data={seoulCrimeData} year="2014"/>
            </>}
        </Container>
    );
};
