...
const SeoulCrimeMap2018 = props => {
    ...
    const OnEachDistrict = (district, layer) =>{
        ...
        const totalIncidentsText      = district.properties.totalIncidents_2018;
        ...
        layer.options.fillColor = district.properties.totalIncidents_2018Color;
    ...
    return(
        <Container fixed className={classes.container}>
            ...
            <Typography variant="subtitle1" className={classes.message}>*The data is based on the total number of incidents in 2018</Typography>
            <ShowSeoulDistrictCrimeData data={seoulCrimeData} year="2018"/>
            </>}
        </Container>
    );
};

export default SeoulCrimeMap2018;